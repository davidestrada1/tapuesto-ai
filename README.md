...
- **one-pager animated diagram:** **[Animated Architecture Diagram](https://davidestrada1.github.io/tapuesto-ai/slides/architecture_1page.html)** to see how the React client, Gemini API, and Reputation system interact in real-time.
