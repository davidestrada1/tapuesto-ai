        ...
        <div className="relative flex min-h-screen w-full flex-col bg-background-light dark:bg-background-dark">
            ...
            <div className="flex-1 px-4 py-8 md:px-10 lg:px-20 xl:px-40 flex justify-center">
                <div className="layout-content-container flex flex-col max-w-[1280px] flex-1 gap-8">
                    <h1 className="text-white text-[28px] md:text-[32px] font-bold leading-tight text-left">Bienvenido de nuevo, Alejandro.</h1>
                    <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-4">
                        ...
                        <div className="flex flex-col gap-2 rounded-lg p-6 bg-[#233c48] border border-white/5 shadow-lg">
                            <div className="flex justify-between items-start">
                                <p className="text-[#92b7c9] text-sm font-medium">Tasa de Acierto</p>
                    ...
                    <div className="flex flex-col gap-4">
                        <div className="flex justify-between items-center">
                            <h2 className="text-white text-[22px] font-bold">Mis Apuestas Activas</h2>
                            ...
                            <div className="overflow-x-auto">
                                <table className="w-full text-left text-sm text-white">
                                    <thead className="bg-[#1e343f] text-[#92b7c9] text-xs uppercase tracking-wider">
                                        <tr>
                                            <th className="px-6 py-4 font-semibold">Mercado</th>
                                            <th className="px-6 py-4 font-semibold text-center">Resultado</th>
                                            <th className="px-6 py-4 font-semibold text-right">Apostado</th>
                                        </tr>
                                    </thead>
                                    <tbody className="divide-y divide-[#2d4a58]">
                                        <tr className="hover:bg-[#2d4a58]/50 transition-colors">
                                            <td className="px-6 py-4"><p className="font-bold text-white">Crecimiento PBI T4 &gt; 3%</p></td>
                                            <td className="px-6 py-4 text-center"><span className="inline-flex items-center rounded-full bg-green-400/10 px-2.5 py-0.5 text-xs font-medium text-green-400">Sí</span></td>
                                            <td className="px-6 py-4 text-right font-medium">S/ 50.00</td>
                                        </tr>
                                        <tr className="hover:bg-[#2d4a58]/50 transition-colors">
                                            <td className="px-6 py-4"><p className="font-bold text-white">Ganador Perú vs Brasil</p></td>
                                            <td className="px-6 py-4 text-center"><span className="inline-flex items-center rounded-full bg-red-400/10 px-2.5 py-0.5 text-xs font-medium text-red-400">Empate</span></td>
                        ...
                        <div className="rounded-xl bg-[#233c48] p-4 border border-white/5">
                            <div className="relative pl-4 border-l border-[#2d4a58] space-y-6">
                                <div className="relative">
                                    ...
                                    <p className="text-sm text-[#92b7c9]"><span className="font-bold text-white">Apuesta Resuelta:</span> "Miss Perú 2024" finalizó.</p>
                                    <p className="text-xs text-success font-bold mt-1">+ S/ 120.50 Ganancia</p>
                                </div>
                            </div>
                        </div>
                    </div>
