    ...
    const markets: Market[] = [
        {
            ...
            title: t('landing.demoMarkets.m1.title'),
            tag: t('landing.demoMarkets.m1.tag'),
            tagColor: "blue",
            yes: 65,
            no: 35,
            volume: "$12,450",
            expiry: t('landing.demoMarkets.m1.expiry')
        },
        {
            id: '2',
            ...
            title: t('landing.demoMarkets.m2.title'),
            tag: t('landing.demoMarkets.m2.tag'),
            tagColor: "purple",
            yes: 22,
            no: 78,
            volume: "$8,320",
            expiry: t('landing.demoMarkets.m2.expiry')
        },
        {
            id: '3',
            ...
            title: t('landing.demoMarkets.m3.title'),
            tag: t('landing.demoMarkets.m3.tag'),
            tagColor: "orange",
            yes: 48,
            no: 52,
            volume: "$45,200",
            expiry: t('landing.demoMarkets.m3.expiry')
        }
    ];
                ...
                <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
                    <div className="flex h-16 items-center justify-between">
                        ...
                        <nav className="hidden md:flex flex-1 justify-center items-center gap-8">
                            <Link className="text-sm font-medium text-slate-600 hover:text-primary dark:text-slate-300 dark:hover:text-primary transition-colors" to="/dashboard">{t('header.markets')}</Link>
                            <a className="text-sm font-medium text-slate-600 hover:text-primary dark:text-slate-300 dark:hover:text-primary transition-colors" href="#">{t('header.about')}</a>
                            <Link className="text-sm font-medium text-slate-600 hover:text-primary dark:text-slate-300 dark:hover:text-primary transition-colors" to="/leaderboard">{t('header.leaderboard')}</Link>
                            <Link className="text-sm font-medium text-slate-600 hover:text-primary dark:text-slate-300 dark:hover:text-primary transition-colors flex items-center gap-1" to="/portfolio">
            ...
            <main>
                        ...
                        <div className="grid lg:grid-cols-2 gap-12 items-center">
                            <div className="flex flex-col gap-6 text-center lg:text-left">
                                <div className="inline-flex items-center gap-2 self-center lg:self-start px-3 py-1 rounded-full bg-primary/10 border border-primary/20">
                                    ...
                                    <span className="text-xs font-bold text-primary uppercase tracking-wide">{t('landing.live')}</span>
                                </div>
                                <h1 className="text-4xl sm:text-5xl lg:text-6xl font-black leading-tight tracking-tight text-slate-900 dark:text-white">
                                    ...
                                    <span className="text-transparent bg-clip-text bg-gradient-to-r from-primary to-blue-400">{t('landing.titleHighlight')}</span>
                                </h1>
                                ...
                                <div className="aspect-[4/3] rounded-2xl overflow-hidden shadow-2xl bg-slate-900 border border-slate-800 relative group">
                                    ...
                                    <div className="absolute bottom-6 left-6 right-6 flex flex-col gap-3">
                                        <div className="p-4 rounded-xl bg-slate-800/90 backdrop-blur-sm border border-slate-700 shadow-lg transform translate-y-2 group-hover:translate-y-0 transition-transform duration-500">
                                            <div className="flex justify-between items-start mb-2">
                                                <div className="flex items-center gap-2">
                                                    <span className="text-xs font-bold px-2 py-0.5 rounded bg-blue-500/20 text-blue-400">{t('landing.demoMarkets.card1.tag')}</span>
                                                </div>
                                                <span className="text-xs text-slate-400">Vol: $452k</span>
                                            </div>
                                            <p className="font-bold text-white text-sm mb-3">{t('landing.demoMarkets.card1.title')}</p>
                                            <div className="flex items-center gap-2 text-xs">
                                                <div className="flex-1 h-2 bg-slate-700 rounded-full overflow-hidden">
                                                    <div className="h-full bg-green-500 w-[65%]"></div>
                                                </div>
                                                <span className="font-mono text-green-400">65% {t('marketCard.yes')}</span>
                                            </div>
                                        </div>
                                        <div className="p-4 rounded-xl bg-slate-800/90 backdrop-blur-sm border border-slate-700 shadow-lg transform translate-y-2 group-hover:-translate-y-2 transition-transform duration-500 delay-75">
                                            <div className="flex justify-between items-start mb-2">
                                                <div className="flex items-center gap-2">
                                                    <span className="text-xs font-bold px-2 py-0.5 rounded bg-orange-500/20 text-orange-400">{t('landing.demoMarkets.card2.tag')}</span>
                                                </div>
                                                <span className="text-xs text-slate-400">Vol: $1.2m</span>
                                            </div>
                                            <p className="font-bold text-white text-sm mb-3">{t('landing.demoMarkets.card2.title')}</p>
                                            <div className="flex items-center gap-2 text-xs">
                                                <div className="flex-1 h-2 bg-slate-700 rounded-full overflow-hidden">
                                                    <div className="h-full bg-primary w-[42%]"></div>
                                                </div>
                                                <span className="font-mono text-primary">42% {t('marketCard.yes')}</span>
                                            </div>
                                        </div>
                                    </div>
                                </div>
                    ...
                    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8 py-10">
                        <div className="grid grid-cols-2 md:grid-cols-4 gap-8 divide-x divide-slate-100 dark:divide-slate-800/50">
                            <div className="flex flex-col items-center text-center px-4">
                                ...
                                <span className="text-sm text-slate-500 dark:text-slate-400 mt-1">{t('landing.stats.volume')}</span>
                            </div>
                            <div className="flex flex-col items-center text-center px-4">
                                <span className="text-3xl font-black text-slate-900 dark:text-white">50k+</span>
                                <span className="text-sm text-slate-500 dark:text-slate-400 mt-1">{t('landing.stats.predictors')}</span>
                            </div>
                            <div className="flex flex-col items-center text-center px-4">
                                <span className="text-3xl font-black text-slate-900 dark:text-white">99.9%</span>
                                <span className="text-sm text-slate-500 dark:text-slate-400 mt-1">{t('landing.stats.uptime')}</span>
                            </div>
                            <div className="flex flex-col items-center text-center px-4">
                                <span className="text-3xl font-black text-slate-900 dark:text-white">24/7</span>
                                <span className="text-sm text-slate-500 dark:text-slate-400 mt-1">{t('landing.stats.support')}</span>
                            </div>
                        </div>
                    </div>
                </section>
                ...
                <section className="py-20 bg-background-light dark:bg-background-dark">
                    <div className="max-w-[1280px] mx-auto px-4 sm:px-6 lg:px-8">
                        <div className="flex flex-col md:flex-row justify-between items-end md:items-center mb-10 gap-4">
                            <div>
                                <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-2">{t('landing.trending.title')}</h2>
                                <p className="text-slate-500 dark:text-slate-400">{t('landing.trending.subtitle')}</p>
                            </div>
                ...
                <section className="py-20 relative overflow-hidden">
                    ...
                    <div className="max-w-[960px] mx-auto px-4 sm:px-6 lg:px-8 relative z-10 text-center">
                        <h2 className="text-4xl md:text-5xl font-black text-slate-900 dark:text-white mb-6">{t('landing.cta.title')}</h2>
